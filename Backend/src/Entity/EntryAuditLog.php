...
class EntryAuditLog
{
    ...
    public function getOriginalEntryId(): int
    {
        return $this->originalEntryId;
    }

    public function setOriginalEntryId(int $v): static
    {
        $this->originalEntryId = $v;
        return $this;
    }
    ...
    public function setEntryTypeId(int $v): static
    {
        $this->entryTypeId = $v;
        return $this;
    }
