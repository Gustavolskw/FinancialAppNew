...
class ExpenseAuditLog
{
    ...
    public function getOriginalExpenseId(): int { return $this->originalExpenseId; }
    public function setOriginalExpenseId(int $v): static { $this->originalExpenseId = $v; return $this; }
    ...
    public function getExpenseTypeId(): int { return $this->expenseTypeId; }
    public function setExpenseTypeId(int $v): static { $this->expenseTypeId = $v; return $this; }

    public function getPaymentMethodId(): int { return $this->paymentMethodId; }
    public function setPaymentMethodId(int $v): static { $this->paymentMethodId = $v; return $this; }

    public function getInstallments(): int { return $this->installments; }
    public function setInstallments(int $v): static { $this->installments = $v; return $this; }
