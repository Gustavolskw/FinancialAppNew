...
use App\Entity\ExpenseAuditLog as ExpenseAuditLogEntity;
...
final class ExpenseAuditLogConfiguration extends ConfigurableEntity
{
    private const string ENTITYCLASS = ExpenseAuditLogEntity::class;
    public const string LISTDATATERM = "expenseAuditLogs";
    public const string SINGLEDATATERM = "expenseAuditLog";
    ...
    public function configureFields(FieldsAttributeInterface $fields): FieldsAttributeInterface
    {
        ...
        return $fields
            ->setIdField("id")
            ->setNumericField("originalExpenseId", "getOriginalExpenseId")
            ->setNumericField("originalTransactionId", "getOriginalTransactionId")
            ->setNumericField("expenseTypeId", "getExpenseTypeId")
            ->setNumericField("paymentMethodId", "getPaymentMethodId")
            ->setNumericField("installments", "getInstallments")
