...
description: Use when creating or changing configurable Configurations under src/Infrastructure/DTO/Configuration, including field configuration, form value mapping, entity output, relation output, list/single response terms, and new CRUD DTO requirements.
---
