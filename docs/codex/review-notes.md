...
Este arquivo fica na raiz do monorepo. As notas abaixo preservam riscos do backend. Para o
frontend, consulte também `frontEnd/docs/codex/review-notes.md`; para Docker, consulte
...
### Frontend Ainda Está No Template

Arquivos: `frontEnd/app/routes/home.tsx`, `frontEnd/app/welcome/*`, `frontEnd/README.md`

O frontend ainda usa o template inicial do React Router. Ao implementar telas, substitua o conteúdo genérico por uma experiência real do AppFinancasNew.
